package ru.daniil.photoeditor.controllers;
...
import ru.daniil.photoeditor.dto.image.ListImageResponseDto;
import ru.daniil.photoeditor.dto.image.UploadImageResponseDto;
import ru.daniil.photoeditor.exceptions.NotFoundException;
import ru.daniil.photoeditor.mappers.ImageMapper;
...
public class ImageController {
    ...
    public ListImageResponseDto getImages() {
        return new ListImageResponseDto(imageService.getAllByUser().stream().map(imageMapper::toImageResponseDto).toList());
    }
